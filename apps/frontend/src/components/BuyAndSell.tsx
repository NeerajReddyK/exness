        ...
        <div className="flex items-center justify-center flex-col m-2 gap-4">
            <div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <label htmlFor="quantity" className="text-xl">SOLUSDC</label>
                    <input type="number" placeholder="quantity" id="quantity" className="border" onChange={(e) => setBuyQuantity(Number(e.target.value))} />
                </div>
                <button onClick={handleBuySubmit} className="mt-2 bg-blue-500 py-2 rounded-lg w-full cursor-pointer">Submit</button>
            </div>
            <div>
                ...
                <div className="flex flex-col gap-3">
                     ...
                     should change when state management library is added. */}
                    <label htmlFor="quantity" className="text-xl">SOLUSDC</label>
                    <input type="number" placeholder="quantity" id="quantity" className="border" onChange={(e) => setSellQuantity(Number(e.target.value))} />
                </div>
                <button onClick={handleSellSubmit} className="mt-2 bg-blue-500 py-2 rounded-lg w-full cursor-pointer">Submit</button>
            </div>
        </div>
    )
}